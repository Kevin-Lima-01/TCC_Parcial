...
####
# Desocupados
DES_PME <- read_excel("FGV/TCC/Dados/Desemprego/PME/DES_PME.xlsx")
...
# PEA
PEA_PME <- read_excel("FGV/TCC/Dados/Desemprego/PME/PEA_PME.xlsx")
...
write_xlsx(PME, "FGV/TCC/Dados/Desemprego/PME/PME_sub14_m.xlsx")
...
write_xlsx(PME_trim, "FGV/TCC/Dados/Desemprego/PME/PME_sub14_t.xlsx")